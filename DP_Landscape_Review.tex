...
The Data Seal of Approval has been awarded to 24 repositories following a consdierably more streamlined process.
...
The recently finalized Joint Declaration of Data Citation principles states that if a researcher uses a published data set in a paper, she should cite the dataset formally in the reference list. 
