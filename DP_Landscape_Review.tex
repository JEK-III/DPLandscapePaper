...
However, tDAR also serves as a platform for high-quality data publication; the repository accepts rich description when authors provide it, and two third-party journals, \emph{Internet Archaeology} and \href{http://openarchaeologydata.metajnl.com/}{\emph{Journal of Open Archaeological Data}}, peer-review tDAR data in conjunction with data papers.  
