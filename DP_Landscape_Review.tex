...
Here, we will discuss three non-mutually-exclusive relationships with the literature: a dataset may \textbf{supplement} a traditional research paper, be the \textbf{subject} of a ``data paper,'' or be \textbf{independent} of any paper.
...
An independently documented dataset might nevertheless be linked to the literature through a data paper or traditional articles.  
Independent data publishers do, of course, publishd data that supports papers and is the subject of papers too, so the situation is complex.
Diverse place- and interest-based research communities publish data with or without linkages to the literature in diverse places through diverse processes.
