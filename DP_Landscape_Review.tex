...
Lawrence et al. (2011) adopt a process-oriented perspective, laying out the functions the publication process should perform, and sorting data publications into five models distinguished ``by how the roles involved in publication are distributed between the various actors'' (i.e. the author, archive, or journal)\cite{lawrence_data_2011}.
Here, we will consider data consider data that is available, documented, and citable to be published.
