...
Even as data publications proliferate, there is still significant debate over formats, processes, and terminology.
Here we present an overview of the data publication initiatives underway and the current conversation, highlighting places where consensus seems to have been reached and issues still in contention.
...
Data is published as supplemental material to a journal article, with a descriptive ``data paper'', or independently.
Further complicating the situation, the same terms are used by different initiatives to refer to related but distinct concepts.
