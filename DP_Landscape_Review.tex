...
\subsection*{Independent datasets review}\label{independent-datasets-review}

While data journals tend to stick to traditional criteria (if not processes), other things are possible.
Lawrence (2011) lays out a set of criteria for data peer review.\cite{lawrence_citation_2011}
NASA Planetary Data System (PDS) conducts peer review in an in-person meeting with representatives of the repository, the dataset creators, and the reviewers. %ref and maybe how long this has been going on?

An example of a flexible review system that optionally incorporates peer review is Open Context.
...
\subsection*{Post publication validation}\label{post-publication-validation}
Post publication review might be a better way to go.
...
PLOS Open Comment tool is similar to this.

Parsons says context is more important, documenting use.\cite{parsons_data_2011}
