...
\emph{GigaScience}, an exception, assigns rechnical review of the dataseta to a separate data reviewer.
The guidelines that various data journals provide to reviewers are roughly similar, with the exception that about half of consider novelty or potential impact, while the rest only require that the dataset be scientifically sound.
In contrast, review processes differ widely. %doyle: what are you meaning?
