...
Reviewer guidlines are roughly similar accross journals, although roughly half of the journals we looked at consider novelty or potential impact, while the others only require that the dataset be scientifically sound.
...
As an example, let's compare Nature Scientific Data and Biodiveristy jounral.
The two journals divide reviewer guidlines into three similar sections– quality of the data, quality of the description, and consistency between the description and the data– and provide similar guidance.
