...
%add reuse
%OC cost of publication vs. collection
While the cost of storing and publishing data is not negligible, it is far less expensive than the initial cost of creating the data.
Piwowar contrasted \$400,000 in National Science Foundation (NSF) grants to generate 16 papers with an estimate that the same \$400,000 invested in publishing data via Dryad could contribute to over 1,000 publications.\cite{piwowar_data_2011}
