...
The five data publication models described by Lawrence (2011) are distinguished ``by how the roles involved in publication are distributed between the various actors'' (e.g. the author, archive or journal).\cite{lawrence_data_2011}
...
The distinction between a data repository and a data publisher is often indisctinct.
...
\emph{GigaScience}, an exception, assigns technical review of the dataseta to a separate data reviewer.
...
The repository accomodates contributors who wish to provide more information, and much of the content is deposited by digital curators who always supply rich descriptions.
...
Ultimately, while ``data as software'' is promising, data is not sofware.
