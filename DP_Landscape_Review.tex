...
A data paper is a novel class of journal article that describes a dataset by detailing the rationale and collection methods, but omits results and discussion. 
...
With few exceptions, data journals require the data itself to be published in a trusted third-party repository. 
