...
Within the scholarly communication community, two properties of a data publication are widely agreed on.\cite{smith_data_2009,callaghan_making_2012}
...
Traditional article publishers frequenlty require that the data underlying the figures and results in an article be furnished to interested parties on request.\cite{alsheikh_public_2011}
