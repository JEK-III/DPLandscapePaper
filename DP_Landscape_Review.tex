...
Callaghan et al. (2012) draw an explicit distinction between Published and published data: \underline{p}ublished data is at least available, while \underline{P}ublished data is persistent, documented, and peer-reviewed\cite{sarah_callaghan_making_2012}.
...
Despite uncertainty over precisely what quailifies, the scholarly communication community largely agrees on three essential properties of a data publication (Figure 1)\cite{smith_data_2009,sarah_callaghan_making_2012}.
...
Here, we will consider data that is persistenly available, documented to some extent, and citable to be published, whatever the level of validation. 
