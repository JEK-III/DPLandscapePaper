...
Other broad-content repositories are  centered around institutions (e.g. the \href{https://purr.purdue.edu/}{Purdue Research Repository}) or countries (e.g. the Dutch \href{http://www.dans.knaw.nl/en}{Data Archiving and Networked Services (DANS)}).

Narrow-conent one might be based on discipline (e.g. \href{http://www.tdar.org/}{the Digital Archaeological Record (tDAR)}), research community (e.g. databases like \href{http://www.wormbase.org/}{WormBase}\cite{harris_wormbase_2014} or \href{http://flybase.org/}{FlyBase}\cite{pierre_flybase_2014} centered around a particular model organism ), data-type (e.g. DNA sequences are deposited in \href{http://www.ncbi.nlm.nih.gov/genbank/}{GenBank}\cite{benson_genbank_2013} and protein structures in the \href{http://www.rcsb.org/}{Protein Data Bank}\cite{berman_protein_2000}), or scientific instrument (e.g. ).

, disciplines , 

Other third-party repositories include \href{http://figshare.com/}{Figshare}, \href{http://zenodo.org/}{Zenodo}, institutional repositories , and discipline-specific repositories .
