...
Making data a first class research object would accomplish several goals: ensuring access, preservation, and discovery of data for the benefit of reusers and enabling citation to better credit and reward authors.
...
\todo[inline]{reproducibility crisis: cite Economist, NYT, most published results are wrong}
...
Data papers are flourishing in new journals dedicated to the format, such as Nature's \emph{Scientific Data}\cite{nature_scientific_data}; \emph{Geoscience Data Journal}\cite{geoscience_data_journal}; and a trio of ``metajournals'' from Ubiquity Press\cite{ubiquity_press_metajournals}, as well as in journals that publish other types of papers, such as \emph{F1000 Research}\cite{f1000_research}; \emph{Internet Archaeology}\cite{internet_archaeology}; and \emph{GigaScience}\cite{gigascience}. 
